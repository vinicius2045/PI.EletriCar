...
const handleAlugarPress = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.carText}>Kwid e-Tech</Text>

      <View style={styles.imageContainer}>
        <Image
          source={require('./assets/kwid.png')}
      ...
      <View style={styles.buttonRow}>
        <TouchableOpacity style={styles.button}>
          <Text style={styles.buttonText}>Seis Airbags</Text>
        </TouchableOpacity>
      ...
      <View style={styles.buttonRow}>
        <TouchableOpacity style={styles.button}>
          <Text style={styles.buttonText}>Ar - Condiocionado</Text>
        </TouchableOpacity>
      ...
      <View style={styles.imageContainer}>
        ...
        <View style={styles.iconTextContainer}>
          <Text style={styles.iconText}>Potência e torque: 65 cv e 11,4 kgfm</Text>
          <Text style={styles.iconText}>Autonomia: 185 km</Text>
