...
const handleAlugarPress = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.carText}>E-JSI</Text>

      <View style={styles.imageContainer}>
        <Image
          source={require('./assets/jac.png')}
      ...
      <View style={styles.buttonRow}>
        <TouchableOpacity style={styles.button}>
          <Text style={styles.buttonText}>Piloto Automático
</Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.button}>
          <Text style={styles.buttonText}>Câmera de 360 Graus</Text>
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.imageContainer}>
        ...
        <View style={styles.iconTextContainer}>
          <Text style={styles.iconText}>Potência e torque: 136 cv e 40,3 kgfm</Text>
          <Text style={styles.iconText}>Autonomia: 252 km</Text>
